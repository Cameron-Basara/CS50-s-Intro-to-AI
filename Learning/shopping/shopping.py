...
def evaluate(labels, predictions):
    ...
    """
    # evaluate based on preds and labels
    true_positives = sum(1 for y, p in zip(labels, predictions) if y == 1 and p == 1)
    true_negatives = sum(1 for y, p in zip(labels, predictions) if y == 0 and p == 0)
